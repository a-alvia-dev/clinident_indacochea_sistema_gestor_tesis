...
import { Plus, Check, FileText, Calendar, Trash2 } from 'lucide-react';
...
export default function EvolucionesSeccion({ pacienteId, historiaId, evolucionesIniciales }: Props) {
  ...
  return (
    <div className="space-y-6">
      {/* CARD FORMULARIO: REGISTRAR NUEVA EVOLUCIÓN / ATENCIÓN */}
        ...
        <form onSubmit={guardarEvolucion} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 space-y-1.5">
              ...
              <input
                type="text"
                placeholder="Ej: Resina en pieza 14, Limpieza dental..."
                value={procedimiento}
        ...
        {evoluciones.length === 0 ? (
          <div className="text-center py-10 space-y-2">
            ...
            <p className="text-[11px] text-slate-400">
              Usa el formulario de arriba para registrar la primera consulta de trabajo.
            </p>
          </div>
        ) : (
              ...
              <div key={evo.id} className="p-4 bg-slate-50/70 border border-slate-200/80 rounded-xl space-y-2">
                <div className="flex justify-between items-start text-xs">
                  <div className="space-y-0.5">
                    <span className="font-bold text-slate-800 block text-sm">{evo.procedimiento}</span>

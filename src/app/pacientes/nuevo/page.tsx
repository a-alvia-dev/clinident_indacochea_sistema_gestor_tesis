    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-slate-800 p-6 md:p-8 rounded-2xl border border-slate-700 shadow-xl space-y-5">
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-slate-700">
          <Link
            href="/pacientes"
            className="px-4 py-2.5 bg-slate-700 hover:bg-slate-600 font-medium rounded-xl text-slate-200 transition-colors text-sm"
          >
            Cancelar
          </Link>
          <button
            type="submit"
            disabled={isPending}
            className="px-6 py-2.5 bg-blue-600 hover:bg-blue-500 font-medium rounded-xl text-white transition-colors disabled:opacity-50 text-sm"
          >
